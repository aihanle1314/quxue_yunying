    ...
    <div class="projrole-container">
      <el-dialog :title="addTitle" :visible.sync="addVisible">
       ...
       <div class="box-header">
          <el-button type="primary" icon="el-icon-plus" size="small" @click="handleAdd">添加机构角色</el-button>
        </div>
        <el-table :data="tableData" border size="small" class="proj-table" ref="multipleTable">
            ...
            <el-table-column align="center" prop="r_name" label="角色名称" width="260">
            </el-table-column>
...
<script>
import { getRoleList, updateRole, delRole } from '@/http/api/jigouRequest'
export default {
  name: 'projrole',
  data () {
    return {
