...
//                        O = this.container.getElementsByClassName("dplayer-setting-icon")[0],
		      O = this.container.getElementsByClassName("dplayer-speed-icon")[0],
...
*/
                ...
                return s(e, [{
                    ...
                    key: "play",
                    value: function() {
                        if (this.paused = !1, this.video.paused && (this.bezel.innerHTML = this.icons.get("play"), this.bezel.classList.add("dplayer-bezel-transition")),
			...
			this.video.paused || (this.bezel.innerHTML = this.icons.get("pause"), this.bezel.classList.add("dplayer-bezel-transition")), 
			this.ended = !1, 
			...
			this.danmaku && this.danmaku.pause()
			    ...
			    n.loop ? (n.seek(0), e.play()) : (n.ended = !0, n.pause()),
        ...
        e.exports = function(e) {
            ...
            return e.video && !e.video.type && (e.video.type = "auto"), "object" === i(e.danmaku) && e.danmaku && !e.danmaku.user && (e.danmaku.user = "DIYgod"), e.subtitle && (!e.subtitle.type && (e.subtitle.type = "webvtt"), !e.subtitle.fontSize && (e.subtitle.fontSize = "20px"), !e.subtitle.bottom && (e.subtitle.bottom = "40px"), !e.subtitle.color && (e.subtitle.color = "#fff")), e.video.quality && (e.video.url = [e.video.quality[e.video.defaultQuality].url]), e.lang && (e.lang = e.lang.toLowerCase()), e.icons && (e.icons = Object.assign({}, t.icons, e.icons)), e.contextmenu = e.contextmenu.concat([{
                text: "About author",
                link: "https://digod.me"
            }, {
                text: "About DPlayer",
